...
namespace Dacastro4\LaravelGmail\Facade {
        class LaravelGmail
        {
             ...
             *
             * @param array|string $scope the scope is expressed as an array or list of space-delimited strings
             *
             * @return string
             * @static
             */
             ...
             *
             * @see https://developers.google.com/+/api/moment-types
             *
             ...
             *
             * @param null|array|string $token the token (access token or a refresh token) that should be revoked
             *
             ...
             * isn't provided.
             *
             * @param null|string $idToken the token (id_token) that should be verified
             *
             ...
             * @param null|false|\Google\class-string<T> $expectedClass
             *
             * @throws \Google\Exception
             *
             * @return \Google\ResponseInterface|\Google\T|mixed
             * @static
             */
