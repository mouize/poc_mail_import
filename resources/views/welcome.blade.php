    ...
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @if(LaravelGmail::check())
                <a href="{{ url('oauth/gmail/logout') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Logout</a>
            @else
                <a href="{{ url('oauth/gmail') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Log in</a>
            @endauth
        </div>
